...
public class RemoteDriver {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while ((fromServer = in.readLine()) != null) {
        	...
        	/////////////////////////////////////////////////////////////////////////////////////
        	// TODO sua logica fuzzy vai aqui use os valores de x,y e angle obtidos. x e y estao em [0,1] e angle [0,360)
        	 // Load from 'FCL' file
			...
			fb.getVariable("direction").defuzzify();
			
			//double teste = Double.valueOf(stdIn.readLine());
        	
        	double teste = fb.getVariable("direction").getValue();
